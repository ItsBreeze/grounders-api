 ...
 * Auth routes
 *
 * POST /auth/request-otp  — send OTP via SMS (Twilio) or DEV_MODE echo
...
router.post('/refresh', async (req, res, next) => {
  try {
    ...
    await storeRefreshToken(matched.user_id, newRefreshToken);
    ...
    res.json({
      ...
      user: {
        ...
        phone: matched.phone,
        email: matched.email,
        total_distance_m: matched.total_distance_m,
