...
-- Self-contained: no FKs into the Grounders tables, so this whole feature can
-- be lifted into its own service by moving these four tables.

-- One row per linked mailbox. Tokens are AES-256-GCM ciphertext (crypto_box),
-- never plaintext. owner_key is the MCP token subject that owns the link.
